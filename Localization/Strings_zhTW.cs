...
namespace L1MapViewer.Localization
{
    ...
    public static class Strings_zhTW
    {
        public static Dictionary<string, string> GetStrings() => new()
        {
            ...
            { "Menu_Help_SourceCode", "原始碼 (GitHub)" },
            { "Menu_Help_PakViewer", "PakViewer (PAK 編輯器)" },
            { "Menu_Help_About", "關於..." },
            { "Menu_Language", "語言" },
            ...
            // === Map Export Dialog ===
            { "Menu_File_ExportMapImage", "輸出地圖圖片..." },
            { "Dialog_MapExport_Title", "輸出地圖圖片" },
            { "Dialog_MapExport_Layers", "圖層選項" },
            { "Dialog_MapExport_Mode", "輸出模式" },
            { "Dialog_MapExport_SingleMap", "當前地圖" },
            { "Dialog_MapExport_BatchAll", "所有地圖" },
            { "Dialog_MapExport_Scale", "圖片尺寸" },
            { "Dialog_MapExport_ScaleHint", "縮小可減少檔案大小，品質仍為無損" },
            { "Dialog_MapExport_Scale100", "(原始尺寸)" },
            { "Dialog_MapExport_OutputPath", "輸出路徑" },
            { "Dialog_MapExport_CustomMarkers", "自訂標記" },
            { "Dialog_MapExport_MarkersHint", "輸入座標清單 (X, Y, 名稱 - Tab 或逗號分隔)" },
            { "Dialog_MapExport_MarkerSize", "標記大小 (1=大地圖適用, 10=縮圖適用)" },
            { "Dialog_MapExport_Export", "輸出" },
            { "Dialog_MapExport_Exporting", "正在輸出...請稍後" },
            { "Dialog_MapExport_Success", "輸出完成" },
            { "Dialog_MapExport_MaxSizeFormat", "100% = {0} x {1} (最大可輸出尺寸)" },
            { "Dialog_MapExport_BatchSizeHint", "批次輸出將自動計算每張地圖的最大尺寸" },
            { "Layer1_Name", "地板" },
            { "Layer2_Name", "裝飾" },
            { "Layer4_Name", "物件" },
            { "Layer8_Name", "SPR" },
