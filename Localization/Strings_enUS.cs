...
namespace L1MapViewer.Localization
{
    ...
    public static class Strings_enUS
    {
        public static Dictionary<string, string> GetStrings() => new()
        {
            ...
            { "Menu_Help_SourceCode", "Source Code (GitHub)" },
            { "Menu_Help_PakViewer", "PakViewer (PAK Editor)" },
            ...
            { "Dialog_MapExport_Title", "Export Map Image" },
            { "Dialog_MapExport_Layers", "Layer Options" },
            { "Dialog_MapExport_Mode", "Export Mode" },
            { "Dialog_MapExport_SingleMap", "Current Map" },
            { "Dialog_MapExport_BatchAll", "All Maps" },
            { "Dialog_MapExport_Scale", "Image Size" },
            { "Dialog_MapExport_ScaleHint", "Smaller size reduces file size, quality remains lossless" },
            { "Dialog_MapExport_Scale100", "(Original size)" },
            { "Dialog_MapExport_OutputPath", "Output Path" },
            { "Dialog_MapExport_CustomMarkers", "Custom Markers" },
            { "Dialog_MapExport_MarkersHint", "Enter coordinate list (X, Y, Name - Tab or comma separated)" },
            { "Dialog_MapExport_MarkerSize", "Marker Size (1=for large map, 10=for thumbnail)" },
            { "Dialog_MapExport_Export", "Export" },
            { "Dialog_MapExport_Exporting", "Exporting...please wait" },
            { "Dialog_MapExport_Success", "Export completed" },
            { "Dialog_MapExport_MaxSizeFormat", "100% = {0} x {1} (Max exportable size)" },
            { "Dialog_MapExport_BatchSizeHint", "Batch export will auto-calculate max size for each map" },
            { "Layer1_Name", "Floor" },
