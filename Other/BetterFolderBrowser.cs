...
namespace L1MapViewer.Other {
    /*
     Code Form https://github.com/Willy-Kimura/BetterFolderBrowser
     by Willy Kimura
     */
    ...
    public partial class BetterFolderBrowser : CommonDialog {
        ...
        private BetterFolderBrowserDialog _dialog =
            new BetterFolderBrowserDialog();
        ...
        public bool Multiselect {
            ...
            set {
                _dialog.AllowMultiselect = value;
            }
        }
...
public class BetterFolderBrowserDialog {
    ...
    public bool ShowDialog(IntPtr hWndOwner) {
        ...
        if (Environment.OSVersion.Version.Major >= 6) {
            var r = new WindowWrapper.Reflector("System.Windows.Forms");
